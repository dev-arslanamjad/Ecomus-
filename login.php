                        ...
                        <ul class="sub-nav-menu" id="sub-menu-navigation">
                            <li><a href="#sub-shop-one" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                                ...
                                <div id="sub-shop-one" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li><a href="shop-collection-sub.php" class="sub-nav-link">Sub collection</a>
                                        </li>
                                        <li><a href="shop-collection-list.php" class="sub-nav-link">Collections list</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                ...
                                <div id="sub-shop-two" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li><a href="shop-loadmore.php" class="sub-nav-link">Pagination loadmore</a>
                                        </li>
                                        <li><a href="shop-infinite-scrolling.php" class="sub-nav-link">Pagination
                                                infinite scrolling</a></li>
                                        <li><a href="shop-filter-sidebar.php" class="sub-nav-link">Filter sidebar</a>
                                        </li>
                            ...
                            <li>
                                ...
                                <div id="sub-shop-three" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li><a href="product-style-list.php" class="sub-nav-link">Product style list</a>
                                        </li>
                                        <li><a href="product-style-01.php" class="sub-nav-link">Product style 01</a>
                                        </li>
                                        <li><a href="product-style-02.php" class="sub-nav-link">Product style 02</a>
                                        </li>
                                        <li><a href="product-style-03.php" class="sub-nav-link">Product style 03</a>
                                        </li>
                                        <li><a href="product-style-04.php" class="sub-nav-link">Product style 04</a>
                                        </li>
                                        <li><a href="product-style-05.php" class="sub-nav-link">Product style 05</a>
                                        </li>
                                        <li><a href="product-style-06.php" class="sub-nav-link">Product style 06</a>
                                        </li>
                                        <li><a href="product-style-07.php" class="sub-nav-link">Product style 07</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <ul class="sub-nav-menu" id="sub-menu-navigation">
                            <li>
                                ...
                                <div id="sub-product-one" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li><a href="product-right-thumbnails.php" class="sub-nav-link">Product right
                                                thumbnails</a></li>
                                        <li><a href="product-bottom-thumbnails.php" class="sub-nav-link">Product bottom
                                                thumbnails</a></li>
                                        <li><a href="product-drawer-sidebar.php" class="sub-nav-link">Product drawer
                                                sidebar</a></li>
                                        <li><a href="product-description-accordion.php" class="sub-nav-link">Product
                                                description accordion</a></li>
                                        <li><a href="product-description-list.php" class="sub-nav-link">Product
                                                description list</a></li>
                                        <li><a href="product-description-vertical.php" class="sub-nav-link">Product
                            ...
                            <li>
                                ...
                                <div id="sub-product-two" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li><a href="product-inner-zoom.php" class="sub-nav-link">Product inner zoom</a>
                                        </li>
                                        <li><a href="product-zoom-magnifier.php" class="sub-nav-link">Product zoom
                                                magnifier</a></li>
                                        <li><a href="product-no-zoom.php" class="sub-nav-link">Product no zoom</a></li>
                                        <li><a href="product-photoswipe-popup.php" class="sub-nav-link">Product
                                                photoswipe popup</a></li>
                                        <li><a href="product-zoom-popup.php" class="sub-nav-link">Product external zoom
                                                and photoswipe popup</a></li>
                                        <li><a href="product-video.php" class="sub-nav-link">Product video</a></li>
                                        <li><a href="product-3d.php" class="sub-nav-link">Product 3D, AR models</a></li>
                                        <li><a href="product-options-customizer.php" class="sub-nav-link">Product
                                                options & customizer</a></li>
                                        <li><a href="product-advanced-types.php" class="sub-nav-link">Advanced product
                                                types</a></li>
                                        <li><a href="product-giftcard.php" class="sub-nav-link">Recipient information
                            ...
                            <li>
                                ...
                                <div id="sub-product-three" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li><a href="product-color-swatch.php" class="sub-nav-link">Product color
                                                swatch</a></li>
                                        <li><a href="product-rectangle.php" class="sub-nav-link">Product rectangle</a>
                                        </li>
                                        <li><a href="product-rectangle-color.php" class="sub-nav-link">Product rectangle
                                                color</a></li>
                                        <li><a href="product-swatch-image.php" class="sub-nav-link">Product swatch
                                                image</a></li>
                                        <li><a href="product-swatch-image-rounded.php" class="sub-nav-link">Product
                                                swatch image rounded</a></li>
                                        <li><a href="product-swatch-dropdown.php" class="sub-nav-link">Product swatch
                                                dropdown</a></li>
                                        <li><a href="product-swatch-dropdown-color.php" class="sub-nav-link">Product
                            ...
                            <li>
                                ...
                                <div id="sub-product-four" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li><a href="product-frequently-bought-together.php"
                                                class="sub-nav-link">Frequently bought together</a></li>
                                        <li><a href="product-frequently-bought-together-2.php"
                                                class="sub-nav-link">Frequently bought together 2</a></li>
                                        <li><a href="product-upsell-features.php" class="sub-nav-link">Product upsell
                                                features</a></li>
                                        <li><a href="product-pre-orders.php" class="sub-nav-link">Product pre-orders</a>
                                        </li>
                                        <li><a href="product-notification.php" class="sub-nav-link">Back in stock
                                                notification</a></li>
                                        <li><a href="product-pickup.php" class="sub-nav-link">Product pickup</a></li>
                                        <li><a href="product-images-grouped.php" class="sub-nav-link">Variant images
                                                grouped</a></li>
                                        <li><a href="product-complimentary.php" class="sub-nav-link">Complimentary
                                                products</a></li>
                                        <li><a href="product-quick-order-list.php" class="sub-nav-link line-clamp">Quick
                                                order list<div class="demo-label"><span class="demo-new">New</span>
                                                </div></a></li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-mb-item">
                    ...
                    <div id="dropdown-menu-four" class="collapse">
                        <ul class="sub-nav-menu" id="sub-menu-navigation">
                            ...
                            <li><a href="brands.php" class="sub-nav-link line-clamp">Brands<div class="demo-label"><span
                            ...
                            <li><a href="timeline.php" class="sub-nav-link line-clamp">Timeline<div class="demo-label">
            ...
            <div class="bottom-bar-language">
                <div class="tf-currencies">
                    <select class="image-select center style-default type-currencies">
                        ...
                        <option data-thumbnail="assets/frontend/images/country/de.svg">EUR <span>€ | Germany</span>
                        </option>
                        <option selected data-thumbnail="assets/frontend/images/country/us.svg">USD <span>$ | United
                                States</span></option>
                        <option data-thumbnail="assets/frontend/images/country/vn.svg">VND <span>₫ | Vietnam</span>
                        </option>
                    </select>
                </div>
...
<div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile" id="toolbarShopmb">
    ...
    <div class="mb-canvas-content">
        ...
        <div class="mb-bottom">
            <a href="shop-default.php" class="tf-btn fw-5 btn-line">View all collection<i
                            ...
                            <div class="tf-compare-offcanvas">
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="product-detail.php">
                                            <img class="radius-3" src="assets/frontend/images/products/orange-1.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="product-detail.php">
                                            <img class="radius-3" src="assets/frontend/images/products/pink-1.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="wrap">
                ...
                <div class="tf-product-info-buy-button">
                    <form class="">
                        ...
                        <div class="w-100">
                            <a href="#" class="btns-full">Buy with <img src="assets/frontend/images/payments/paypal.png"
                                    alt=""></a>
                ...
                <div class="tf-product-info-wrap position-relative">
                    <div class="tf-product-info-list">
                        <div class="tf-product-info-title">
                            <h5><a class="link" href="product-detail.php">Ribbed Tank Top</a></h5>
                        </div>
                        ...
                        <div>
                            <a href="product-detail.php" class="tf-btn fw-6 btn-line">View full details<i
                                    class="icon icon-arrow1-top-left"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="tf-rte">
                ...
                <div class="tf-page-size-chart-content">
                    ...
                    <div>
                        <img class="sizechart lazyload" data-src="assets/frontend/images/shop/products/size_chart2.jpg"
