                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="assets/frontend/images/logo/logo-white.svg" alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                                        ...
                                        <div class="tf-cur">
                                            <div class="tf-currencies">
                                                <select
                                                    ...
                                                    <option data-thumbnail="assets/frontend/images/country/fr.svg">EUR
                                                        <span>€ | France</span>
                                                    </option>
                                                    <option data-thumbnail="assets/frontend/images/country/de.svg">EUR
                                                        <span>€ | Germany</span>
                                                    </option>
                                                    <option selected
                                                        data-thumbnail="assets/frontend/images/country/us.svg">USD
                                                        <span>$ | United States</span>
                                                    </option>
                                                    <option data-thumbnail="assets/frontend/images/country/vn.svg">VND
                                                        <span>₫ | Vietnam</span>
                                                    </option>
                                                </select>
                                            </div>
